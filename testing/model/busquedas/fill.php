			...
			if($_SESSION['id_tipo_usuario'] == '3')
			{
			    ...
			    $tr_jugadores.='			<td>
								<div class="center">
									...
									<a class="btn btn-xs btn-secondary" title="Ver información del Jugador" onclick="check_jugador('.$jugador['id'].')">
										<i class="ace-icon fa fa-info-circle bigger-130"></i>
									</a>
								</div>
							</td>
			    ...
			    <div>
									...
									<a class="btn btn-xs btn-secondary inf_btn" title="Ver información del Jugador" onclick="check_jugador('.$jugador['id'].')">
										<i class="ace-icon fa fa-info-circle bigger-130"></i>
									</a>
								</div>
