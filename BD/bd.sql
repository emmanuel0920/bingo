...
-- Volcando datos para la tabla bingo.ganadores: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bingo.padron: ~0 rows (aproximadamente)
DELETE FROM `padron`;
...
-- Volcando datos para la tabla bingo.seccional: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla bingo.usuarios: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla bingo.votos: ~0 rows (aproximadamente)
DELETE FROM `votos`;
...
-- Volcando datos para la tabla bingo.zonal: ~0 rows (aproximadamente)
DELETE FROM `zonal`;
