...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/bingo_estilos/index.css" />
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
											...
											?>
												<fieldset>
													<div class="form-group">
														<label class="block clearfix">
															<span class="block input-icon input-icon-right">
																<input type="text" class="form-control" placeholder="Usuario" name="nick" id="nick" title="Ingresar Usuario" required />
													...
													<div class="form-group">
														<label class="block clearfix">
															<span class="block input-icon input-icon-right">
																<input type="password" class="form-control" placeholder="Contraseña" name="pass" id="pass" title="Ingresar Contraseña" required="required" />
										...
										<div class="toolbar clearfix center" style="background-color: #bababa; min-height: 50px;">
											<h1 class="center"></h1>
											<img src="" width="50">
										</div>
									</div><!-- /.widget-body -->
